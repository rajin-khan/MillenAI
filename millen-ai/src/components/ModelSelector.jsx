      ...
      >
        <div className="bg-zinc-900 rounded-[11px]">
          <button
            ...
            className="flex items-center justify-between w-full px-4 py-2.5 text-sm font-medium text-zinc-100 transition-all duration-200 bg-transparent rounded-xl hover:bg-white/5 focus:outline-none"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-10 w-full mt-2 origin-top-right bg-zinc-900 border border-zinc-700 rounded-xl shadow-2xl"
          >
            <div className="p-2">
              {models.map((model) => (
                <button
